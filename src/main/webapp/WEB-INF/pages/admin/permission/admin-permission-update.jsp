...
<article class="page-container">
    <form action="/space/update" method="post" class="form form-horizontal" id="form-admin-role-add">
        <input type="text" name="sid" value="${space.sid}" hidden>
        <div class="row cl">
                ...
                <dl class="permission-list">
                    ...
                    <dd>
                        <dl class="cl permission-list2">
                            <c:choose>
                                <c:when test="${space.hasInsert}">
                                    <label class="">
                                        <input type="checkbox" value="true" name="hasInsert" id="user-Character-0-0-0" checked>
                                        添加</label>
                                </c:when>
                                <c:otherwise>
                                    <label class="">
                            ...
                            <c:choose>
                                <c:when test="${space.hasUpdate}">
                                    <label class="">
                                        <input type="checkbox" value="true" name="hasUpdate" id="user-Character-0-0-1" checked>
                                        修改</label>
                                </c:when>
                                <c:otherwise>
                                    <label class="">
                            ...
                            <c:choose>
                                <c:when test="${space.hasDelete}">
                                    <label class="">
                                        <input type="checkbox" value="true" name="hasDelete" id="user-Character-0-0-2" checked>
                                        删除</label>
                                </c:when>
                                <c:otherwise>
                                    <label class="">
                            ...
                            <c:choose>
                                <c:when test="${space.hasSelect}">
                                    <label class="">
                                        <input type="checkbox" value="true" name="hasSelect" id="user-Character-0-0-3" checked>
                                        查看</label>
                                </c:when>
                                <c:otherwise>
                                    <label class="">
